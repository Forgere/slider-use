...
(function ($) {
  var Slider = function () {
    ...
    this.init = function (el, o) {
      ...
      //  Arrows support
      if (this.o.arrows) {
        console.log(typeof(this.o.prev));
        console.log(typeof(this.o.next));
    ...
    function nav(name, html) {
      if (name == 'dot') {
        ...
        console.log(typeof(that.o.prev) === 'string');
        html = '<div class="';
  ...
  Slider.prototype = {
    ...
    addImage : function (array, direction, index) {
      if(this.o.romoteArray){
        ...
        if (this.o.lazyload) {
          ...
          $(this.o.render(array[0])).css('left',(this.i - 1) * this.liWidth + 'px').appendTo(this.ul).find('img').width(this.liWidth);
          array.shift();
        }
      }
    },
    lazyload : function (array, direction, index) {
      ...
      var creatImg = this.o.render(array[0]);
